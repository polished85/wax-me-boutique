...
<main class="privacy-page">
	<div class="container">
		...
		<p>Wax Me BOutique (&ldquo;us&rdquo;, &ldquo;we&rdquo;, or &ldquo;our&rdquo;) operates http://www.waxmeboutique.com (the 
		&ldquo;Site&ldquo;). This page informs you of our policies regarding the collection, use and disclosure of 
		...
		limited to your name (&ldquo;Personal Information&rdquo;).</p>
		 
		<h2>Log Data</h2>
		 
		<p>Like many site operators, we collect information that your browser sends whenever you visit our Site 
		(&ldquo;Log Data&rdquo;).</p>
		 
		<p>This Log Data may include information such as your computer's Internet Protocol (&ldquo;IP&rdquo;) address, 
		...
		analyze this&hellip;</p> 
		 
		<p>The Log Data section is for businesses that use analytics or tracking services in websites or 
		apps, like Google Analytics. For the full disclosure section, create your own Privacy Policy.</p> 
		 
		<h2>Communications</h2>
		 
		<p>We may use your Personal Information to contact you with newsletters, marketing or promotional 
		materials and other information that&hellip;</p>  
		 
		<p>The Communications section is for businesses that may contact users via email (email 
		newsletters) or other methods. For the full disclosure section, create your own Privacy Policy.</p>  
		...
		<p>Like many sites, we use &ldquo;cookies&rdquo; to collect information. You can instruct your browser to refuse all 
		...
		<p>This Privacy Policy is effective as of (add date) and will remain in effect except with respect to any 
